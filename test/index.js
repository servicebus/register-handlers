...
describe('register-handlers', function () {
  ...
  it('simplified api should map to correct values and default ack to true', function () {
    ...
    registered.pipelines['domain.command'].should.have.property(
      'queueName',
      'domain.command'
    )
    ...
    registered.pipelines['domain.event'].should.have.property(
      'routingKey',
      'domain.event'
    )
      ...
      handlers: [
        {
          listen: function () {
            ...
            this.should.have.property(
              'routingKey',
              mockMessage.fields.routingKey
            )
            this.should.have.property(
              'correlationId',
              mockMessage.properties.correlationId
            )
